...
Use this method if you downloaded the extension source or ZIP file.
...
4. **Remove Old Version (if installed)**
   - Find the previous version of the extension
   - Click **Remove**

5. **Install the Extension**
   - Drag the **unzipped extension folder** onto the extensions page
